...
project = u'HBP Collaboratory Sphinx Theme'
copyright = u'2015, EPFL/BBP'
...
version = re.search(
    r'[0-9]+\.[0-9]+',
    hbp_collaboratory_sphinx_theme.__version__
).group()
# The full version, including alpha/beta/rc tags.
release = hbp_collaboratory_sphinx_theme.__version__
...
htmlhelp_basename = 'HBPCollaboratorySphinxTheme'
